...
<html lang="de">
    ...
    <script>
        ...
        const chartReporting = new Chart(
            document.getElementById('chartReporting'),
            config
        );
        ...
        function getData(data) {
            ...
            //dfrequency = $.parseJSON(data);
            //console.log("test "+dfrequency);
        }
        ...
        function clickHandler(click) {
            ...
            if(points.length){
                ...
                var linkURL = <?php echo json_encode($linkRepUW_Üb); ?>;
                //console.log(linkURL);
                var stepSelected = value.yAxis.step;
        ...
        chartReporting.canvas.onclick = clickHandler;

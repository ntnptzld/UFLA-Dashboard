...
<html lang="de">
    ...
    <h1 class="schrift1">UFLA-Reporting Übersicht<br>Umspannwerke der Stufe 48,5 Hz</h1>
            ...
            const config = {
                ...
                options: {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: ['Jahresmittel der Abwurfleistungen in den', 'Umspannwerken der Stufe 48,5 Hz'],
                            font: {
                                size: 24
                            }
                        },
